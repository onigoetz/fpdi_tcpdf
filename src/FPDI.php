...
class FPDI extends FPDF\TPL {
    ...
    {
        return new FPDIParser($filename);
    }
    ...
    protected function _writeValue(&$value)
    {
        ...
        switch ($value[0]) {
            ...
            case Parser::TYPE_TOKEN:
                $this->_straightOut($value[1] . ' ');
                break;
            case Parser::TYPE_NUMERIC:
            case Parser::TYPE_REAL:
